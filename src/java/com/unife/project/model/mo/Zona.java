public class Zona {
    ...
    private ind id_piantagione; //FK di piantagione

    public Zona(int coordX, int coordY, int portataSensore, String statoTerreno, float sensoreIluminazione, float sensoreUmidita, float sensoreTemperatura, float sensorePH, float sensoreVento, ind id_piantagione) {
        this.coordX = coordX;
        this.coordY = coordY;
    ...
    public ind getId_piantagione() {
        return id_piantagione;
    }

    public void setId_piantagione(ind id_piantagione) {
        this.id_piantagione = id_piantagione;
    }
